...
const isOwner = [`${setting.ownerNumber}`,"62895383016876@s.whatsapp.net"].includes(sender) ? true : false
...
data_deposit.session = "Nero Botz";
fs.writeFileSync(PathAuto + sender.split("@")[0] + ".json", JSON.stringify(data_deposit, null, 3));
...
_Untuk membeli bahan kepentingan bot whatsapp ini _`
...
conn.sendMessage(from, {image: fs.readFileSync('./function/image/qrisnero.jpg'), caption: donat, mentions: [sender]}, {quoted: floc})
break
case 'cekprem':{
